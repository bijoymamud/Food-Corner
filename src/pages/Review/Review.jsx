...
const Review = () => {
    return (
        <div>
            ...
            <div className='grid grid-cols-3 items-center container gap-5 mx-auto'>
                <div className=' card-body'>
                    <div className='flex items-start gap-5 mb-3'>
                        <img className='h-20 w-20 rounded-full' src="https://images.pexels.com/photos/1689731/pexels-photo-1689731.jpeg?auto=compress&cs=tinysrgb&w=1600" alt="" />
                ...
                <div className=' card-body'>
                    <div className='flex items-start gap-5 mb-3'>
                        <img className='h-20 w-20 rounded-full' src="https://images.pexels.com/photos/2613260/pexels-photo-2613260.jpeg?auto=compress&cs=tinysrgb&w=1600" alt="" />
                ...
                <div className=' card-body'>
                    <div className='flex items-start gap-5 mb-3'>
                        <img className='h-20 w-20  rounded-full' src="https://images.pexels.com/photos/447186/pexels-photo-447186.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" />
